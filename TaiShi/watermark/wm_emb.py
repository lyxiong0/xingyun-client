...
m = 20 # the length of redundant check code
# clusters
# clusters = 9
i_set = set()
j_set = set()
...
def load_data():
    data = pd.read_csv("./data/covtype_10000.csv", encoding='utf-8')
...
def main():
    ...
    # print("the embedded wm !!!")
    # print(msg)
    # print("the encoded watermarking !!!")
    # print([x for x in wm_num])
    k = len(wm_num)
    ...
    data_wm.to_csv("./data/data_wm_1000_em_wm.csv",encoding='utf-8',index=False)
    print("OK")
    ...
    # data_wm = pd.read_csv("~/code/RS_wm/data/data_wm_1000_em_wm.csv",encoding='utf-8')
    # print(data_wm[:2])
    ...
    # data_ext_wm.to_csv("./data/data_1000_ext_wm_2019120115.csv",encoding='utf-8')
    # print(dict_wm)
